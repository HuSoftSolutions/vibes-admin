                ...
                <div className="bg-white p-6 rounded-lg w-full max-w-2xl">
                    ...
                    <form className="space-y-4">
                        ...
                        <div>
                            ...
                            {Object.entries(editedBusiness.preferences).map(([key, value]) => (
                        ...
                        {/* File Upload */}
												<div className="mb-4">
                                <Image
                                    src={editedBusiness?.photoUrl ? editedBusiness.photoUrl : '/no_image.jpg'}
                    ...
                    {businesses.map((business) => (
                        <React.Fragment key={business.id}>
                            <tr className="bg-white border-b">
                                        ...
                                        <Image
                                            src={business?.photoUrl ? business.photoUrl : '/no_image.jpg'}
                                            alt={business.name}
                                            width={50}
                                            height={50}
                                            className="rounded"
                                ...
                                <td className="py-4 px-6">{business.name}</td>
                                <td className="py-4 px-6">{business.address}</td>
                                <td className="py-4 px-6">{business.rating}</td>
                                <td className="py-4 px-6">
                                    <button onClick={() => toggleRow(business.id)}>
                                        {expandedRows[business.id] ? <IoIosArrowUp className="w-5 h-5" />
